    ...
    <>
      <div className="Page_width content_padding" >
        <div className="ml-3 mr-3">
          ...
          <div className="sub_content mt-3 mb-3" style={{ cursor: "pointer" }} onClick={() => setaddMangeopen(!addMangeopen)} ><i class="fa fa-plus" aria-hidden="true"></i> Add New Course</div>
                    ...
                    {(rowsPerPage > 0
                      ...
                      <StyledTableRow>
                        ...
                        >
                          ...
                          <span className='text-info' style={{ cursor: "pointer" }} onClick={()=> navigate("/AddVedio")}><i class="fa fa-plus" aria-hidden="true"></i> Add Video</span>
                        </StyledTableCell>
